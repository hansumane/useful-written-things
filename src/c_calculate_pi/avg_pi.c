 ...
 * This program uses 2^32 + 1 steps from 0 to 1,
 * and calculates 9 significant digits of pi within 12 seconds.
...
int main(void) {
    ...
    const long long unsigned precision = pow(2llu, 32llu);
